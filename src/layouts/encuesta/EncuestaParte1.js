    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            Cuéntanos un poco sobre ti, queremos saber cómo es tu pelo, tu piel
            y tus preferencias en temas de maquillaje y skin care.
          </Typography>
          <Typography variant="h6">
            {" "}
            Queremos conocerte <br /> un poco más
          </Typography>
          <Box
            pb={4}
            component="form"
          ...
          >
            ...
            <Box sx={{ textAlign: "center" }}>
              <IconButton
                sx={{ border: "1px solid #C66CDD", color: "#C66CDD" }}
