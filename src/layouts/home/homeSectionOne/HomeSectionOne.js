    ...
    return (
        <>
            ...
            <Box sx={{ display: { lg: "block", md: "block", xs: "none" } }}>
                <Box mb={3} pt={4} px={2} sx={{ backgroundColor: "#7889FE", textAlign: "left", color: "#fff", display: "flex",height:"600px" }}>
                    <Box pl={6}>
                ...
                <Box px={6} sx={{ textAlign: "left", display: "flex", justifyContent: "start", position:"relative", height:"680px" }} >
                    <Box px={8} >

                       <Box sx={{width:"600px"}} >
                       <Typography variant="h3" sx={{ fontWeight: 700, pt: 10, color: "#C66CDD" }}>Caja Sensebox </Typography>
                        <Typography sx={{pr:18, pt: 5, fontSize: "22px" ,fontWeight: 600,}}>Recibe todos los meses entre 4 y 5 productos sorpresa  <br /><br /> Puedes elegir uno de ellos a tu gusto todos los mes</Typography>
                        <Typography variant="h3" className="textGradient" sx={{ fontWeight: 700, py: 5 }}> 55.900 COP Mensual</Typography>
                        <Button sx={{
                    ...
                    <Box mb={4} sx={{ position: "absolute", top:"-10%", left:"45%"  }}>
                        ...
                        <img src="/assets/img/boxYellowDesktop.png" alt="Maquillaje" border="0" className='imgBoxYellow' />
                    </Box>
